...
import static android.myapplication.ChatService.STATE_CONNECTING;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.BtOff:
                ...
                return true;
            case R.id.Bttest:
                Intent testIntent=new Intent(this,control_Activity.class);
                startActivityForResult(testIntent,REQUEST_CONNECT_DEVICE);
                return true;
        }
        return false;
    }
    ...
    private void setupChat(){
        ...
        //Log.d(TAG,getIntent().getStringExtra("EXTRA_DEVICE_ADDRESS"));
        //connect(getIntent().getStringExtra("EXTRA_DEVICE_ADDRESS"));
    }
